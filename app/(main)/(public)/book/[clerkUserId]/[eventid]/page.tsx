...
export default async function BookingPage({
  ...
  // ✅ FIXED: Changed eventId -> eventid to match your folder name
  params: Promise<{ clerkUserId: string; eventid: string }>;
}) {
  // ✅ FIXED: Await params and use lowercase 'eventid'
  const { clerkUserId, eventid } = await params;

  // Fetch the event details using the corrected ID
  ...
  // If no valid time slots are available, show a message
